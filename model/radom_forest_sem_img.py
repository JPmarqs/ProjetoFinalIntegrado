...
CSV_PATH = 'datatran2025.csv'           # <-- ALTERE PARA O CAMINHO DO SEU ARQUIVO
...
X = df_model[features_categoricas].copy().fillna('Desconhecido')
X_encoded = pd.get_dummies(X, drop_first=False).astype(np.float64)
